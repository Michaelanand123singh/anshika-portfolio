      ...
      >
        ...
        <div className="container-section flex flex-col md:flex-row items-center">
          <div className="w-full md:w-1/2 md:pr-12 z-10">
            <div className="flex items-center mb-4" aria-label="Social media links">
              <a 
                href="https://linkedin.com/in/anshikagupta" 
                target="_blank" 
              ...
              <a 
                href="https://instagram.com/anshikagupta" 
                target="_blank" 
                rel="noopener noreferrer"
                className="mr-4 text-primary hover:text-primary-light"
              ...
              <a 
                href="https://facebook.com/anshikagupta" 
                target="_blank" 
                rel="noopener noreferrer"
